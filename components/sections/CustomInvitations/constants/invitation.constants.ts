...
export const SUGGESTED_MESSAGES = [
  "¡Querida amiga! Te invito a celebrar con nosotros el día más mágico de nuestras vidas. ¡Espero verte brillar junto a nosotros!",
  "¡Familia querida! Este día especial no sería lo mismo sin ustedes. ¡Los esperamos con mucho amor!",
  "¡Hola! Me encantaría que seas parte de nuestra celebración. ¡Será una noche inolvidable!",
...
export const DOWNLOAD_CONFIG = {
  ...
  MIN_WIDTH: 600,
  MIN_HEIGHT: 800,
  FILE_PREFIX: "invitacion_frida_"
} as const;

export const CSS_CLASSES = {
  GRADIENT_PRIMARY: "bg-gradient-to-r from-green-700 via-green-500 to-green-700",
  GRADIENT_SECONDARY: "bg-gradient-to-r from-green-500 to-green-700",
  GRADIENT_SUCCESS: "bg-gradient-to-r from-green-500 to-green-600",
  GRADIENT_PREVIEW: "bg-gradient-to-r from-green-500 to-green-600",
  BORDER_FOCUS: "border-green-200 focus:ring-green-400 focus:ring-2 focus:border-transparent",
