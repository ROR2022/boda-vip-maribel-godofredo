    ...
    <>
      ...
      >
        <button
          ...
          className={`p-2 ${CSS_CLASSES.GRADIENT_SECONDARY} hover:from-green-600 hover:to-green-800 rounded-full shadow-lg transition-colors`}
        ...
        >
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '24px' }}>
              <h3 style={{ fontWeight: 'bold', color: '#6b8c5a', fontSize: '18px', margin: 0 }}>Admin Panel</h3>
              <button
                onClick={() => {
            ...
            <form onSubmit={onAuthenticate} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              <div style={{ position: 'relative' }}>
                <input
                  ...
                  style={{
                    ...
                    border: authError ? '1px solid #fca5a5' : '1px solid #89ac76',
                    borderRadius: '8px',
                    fontSize: '14px',
                    color: 'black',
                    outline: 'none',
                  ...
                  onFocus={(e) => {
                    e.target.style.borderColor = authError ? '#f87171' : '#7a9b69';
                    e.target.style.boxShadow = authError ? '0 0 0 2px rgba(248, 113, 113, 0.2)' : '0 0 0 2px rgba(122, 155, 105, 0.2)';
                  }}
                  onBlur={(e) => {
                    e.target.style.borderColor = authError ? '#fca5a5' : '#89ac76';
              ...
              <button
                ...
                style={{
                  width: '100%',
                  background: 'linear-gradient(to right, #89ac76, #7a9b69)',
                  color: 'white',
                  padding: '12px',
                  borderRadius: '8px',
                  fontWeight: 'bold',
                ...
                onMouseEnter={(e) => {
                  if (password.trim()) {
                    e.currentTarget.style.background = 'linear-gradient(to right, #7a9b69, #6b8c5a)';
                    e.currentTarget.style.boxShadow = '0 10px 15px -3px rgba(0, 0, 0, 0.1)';
                  }
                }}
                onMouseLeave={(e) => {
                  if (password.trim()) {
                    e.currentTarget.style.background = 'linear-gradient(to right, #89ac76, #7a9b69)';
