...
export const InvitationPreview = forwardRef<HTMLDivElement, InvitationPreviewProps>(
  ({ formData }, ref) => {
    return (
      <div 
        ref={ref}
        className="mt-8 p-6 bg-gradient-to-br from-green-600 via-green-500 to-green-700 rounded-2xl text-white shadow-2xl relative overflow-hidden"
      >
        {/* Decoraciones aurora */}
        ...
        <div className="relative z-10 text-center">
          <h2 className="text-2xl font-bold mb-4 text-yellow-200">✨ Maribel & Godofredo ✨</h2>
          ...
          <div className="mt-4 p-3 bg-white/20 rounded-lg">
            <p className="text-sm">💜 Con cariño, Maribel & Godofredo</p>
          </div>
        </div>
      </div>
    );
