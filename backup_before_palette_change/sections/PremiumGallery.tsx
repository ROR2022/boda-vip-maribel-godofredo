  ...
  return (
    ...
    className="py-16 px-4">
      ...
      >
        {/* Header premium */}
        <div className="mb-12">
          <div className="inline-block text-white px-4 py-2 rounded-full text-sm font-medium mb-6 shadow-lg" style={{ background: 'linear-gradient(to right, #89ac76, #7a9b69)' }}>
            📸 Galería
          </div>

          <h2 className={isVisible ? completeClass : basicClass} style={{ color: '#6b8c5a' }}>
            {premiumDemoData.gallery.title}
          </h2>
          <p className="text-xl mb-2" style={{ color: '#7a9b69' }}>
        ...
        <div className="divider">
          <div className="divider-icon">
            <Camera className="w-8 h-8" style={{ color: '#89ac76' }} />
          </div>
        </div>
        <div>
          ...
          {isClient && (
            <>
              <button
                ...
                style={{ background: 'linear-gradient(to right, #89ac76, #7a9b69)' }}
            ...
            <div className="absolute bottom-4 left-0 right-0 flex justify-center gap-2">
              {images.map((_, index) => (
                <button
                  ...
                  style={index === currentIndex ? { backgroundColor: '#89ac76' } : {}}
